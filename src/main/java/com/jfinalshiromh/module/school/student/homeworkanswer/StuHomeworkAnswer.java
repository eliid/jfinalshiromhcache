...
public class StuHomeworkAnswer extends BaseModel<StuHomeworkAnswer> {
    ...
    public static final String TABLE_NAME = "lkk_stu_homework_answer";
    ...
    public String getAnswerByHomeworkAndStu(Integer sid,Integer homeworkId){
    	return Db.queryStr("select student_answer from lkk_student_score where sid=? and homework_id=?",sid,homeworkId);
    }
